...
if(!($stmt = $mysql_handle->prepare("SELECT name, cardType, cost, color, rarity, setName, deckName FROM `cards` WHERE deckName=?"))){
echo "Prepare failed: "  . $stmt->errno . " " . $stmt->error;
}

if(!($stmt->bind_param("s",$_POST['deckName']))){
...
echo '<a href="http://web.engr.oregonstate.edu/~greenlan/projectHTML.php">Return</a>';
